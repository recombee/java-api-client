...
public class AddManualReqlSegmentTest extends RecombeeTestCase {
    ...
    public void testAddManualReqlSegment() throws ApiException {
        ...
        resp = this.client.send(new AddManualReqlSegment("seg1","first-segment","'str_property' != null").setTitle("First Segment"));
    }
}
