...
public class UpdateAutoReqlSegmentationBatchTest extends RecombeeTestCase {
    ...
    public void testUpdateAutoReqlSegmentation() throws ApiException {
        ...
        Request[] requests = new Request[] {
            new UpdateAutoReqlSegmentation("seg1").setTitle("New title").setExpression("{'str_property' + 'str_property'}").setDescription("Updated")
        };
