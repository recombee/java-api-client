...
public class UpdateManualReqlSegmentationBatchTest extends RecombeeTestCase {
    ...
    public void testUpdateManualReqlSegmentation() throws ApiException {
        ...
        Request[] requests = new Request[] {
            new UpdateManualReqlSegmentation("seg1").setTitle("New title").setDescription("Updated")
        };
