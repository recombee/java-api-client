...
public class UpdateManualReqlSegmentBatchTest extends RecombeeTestCase {
    ...
    public void testUpdateManualReqlSegment() throws ApiException {
        ...
        Request[] requests = new Request[] {
            new UpdateManualReqlSegment("seg1","first-segment","'str_property' == null").setTitle("Updated Segment")
        };
