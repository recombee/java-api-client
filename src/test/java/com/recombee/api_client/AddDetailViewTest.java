...
public class AddDetailViewTest extends RecombeeTestCase {
    ...
    public void testAddDetailView() throws ApiException {
        ...
        req = new AddDetailView("entity_id","entity_id").setTimestamp(parseDate("2013-10-29T09:38:41.341Z"));
        resp = this.client.send(req);
        ...
        req = new AddDetailView("entity_id","entity_id").setTimestamp(new Date(-15));
        try {
            this.client.send(req);
            fail("No exception thrown");
        } catch (ResponseException ex) {
        ...
        req = new AddDetailView("u_id2","i_id2").setCascadeCreate(true).setTimestamp(new Date(5));
        resp = this.client.send(req);
        try {
            this.client.send(req);
            fail("No exception thrown");
