...
public class RecommendUsersToUserTest extends RecommendationTestCase {
    ...
    public void testRecommendUsersToUser() throws ApiException {
        ...
        req = new RecommendUsersToUser("nonexisting",9).setCascadeCreate(true);
        resp = this.client.send(req);
        // it 'recommends with expert settings'
        req = new RecommendUsersToUser("nonexisting2",9).setCascadeCreate(true).setExpertSettings(new HashMap<String, Object>(){{}});
        resp = this.client.send(req);
    }
}
