...
public class RecommendUsersToUserTest extends RecommendationTestCase {
    ...
    public void testRecommendUsersToUser() throws ApiException {
        ...
        resp = this.client.send(new RecommendUsersToUser("nonexisting2",9).setCascadeCreate(true).setReqlExpressions(new HashMap<String, String>(){{put("boolean","true");put("number","if ('answer' > 0) then 1 else 2");put("string","\"test\"");}}));
    }
}
