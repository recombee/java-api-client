...
public class RecommendItemsToUserTest extends RecommendationTestCase {
    ...
    public void testRecommendItemsToUser() throws ApiException {
        ...
        resp = this.client.send(new RecommendItemsToUser("nonexisting2",9).setCascadeCreate(true).setReqlExpressions(new HashMap<String, String>(){{put("boolean","true");put("number","if ('answer' > 0) then 1 else 2");put("string","\"test\"");}}));
    }
}
