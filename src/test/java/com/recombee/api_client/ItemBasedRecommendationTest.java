...
public class ItemBasedRecommendationTest extends RecommendationTestCase {
    ...
    public void testRotation() throws ApiException {
        ItemBasedRecommendation req = new ItemBasedRecommendation("entity_id", 9).setTargetUserId("entity_id");
        Recommendation[] recommended1 = this.client.send(req);
        assertEquals(9, recommended1.length);

        ItemBasedRecommendation req2 = new ItemBasedRecommendation("entity_id", 9).setTargetUserId("entity_id").setRotationRate(1);
    ...
    public void testInBatch() throws ApiException {
        ...
        for(int i=0;i<NUM;i++) reqs.add(new ItemBasedRecommendation("entity_id", 9));
    ...
    public void testReturningProperties() throws ApiException {
        ItemBasedRecommendation req = new ItemBasedRecommendation("entity_id", 9).setReturnProperties(true).setIncludedProperties(new String[]{"answer", "id2", "empty"});
        ...
        ItemBasedRecommendation req2 = new ItemBasedRecommendation("entity_id", 9).setReturnProperties(true).setIncludedProperties(new String[]{"answer", "id2"});
        Recommendation[] recommended2 = this.client.send(req2);
