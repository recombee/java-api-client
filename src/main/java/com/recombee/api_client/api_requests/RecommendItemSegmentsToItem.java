 ...
 */
public class RecommendItemSegmentsToItem extends Request {
     ...
     */
    public RecommendItemSegmentsToItem (String itemId,String targetUserId,long count) {
        this.itemId = itemId;
     ...
     * The AI that optimizes models to get the best results may optimize different scenarios separately or even use different models in each of the scenarios.
     */
    public RecommendItemSegmentsToItem setScenario(String scenario) {
     ...
     */
    public RecommendItemSegmentsToItem setCascadeCreate(boolean cascadeCreate) {
     ...
     */
    public RecommendItemSegmentsToItem setFilter(String filter) {
         this.filter = filter;
         return this;
    }
     ...
     */
    public RecommendItemSegmentsToItem setBooster(String booster) {
     ...
     * Logic can also be set to a [scenario](https://docs.recombee.com/scenarios) in the [Admin UI](https://admin.recombee.com).
     */
    public RecommendItemSegmentsToItem setLogic(Logic logic) {
         this.logic = logic;
         return this;
    }
     ...
     */
    public RecommendItemSegmentsToItem setExpertSettings(Map<String, Object> expertSettings) {
     ...
     */
    public RecommendItemSegmentsToItem setReturnAbGroup(boolean returnAbGroup) {
    ...
    public String getPath() {
        return String.format("/recomms/items/%s/item-segments/", this.itemId);
    }
